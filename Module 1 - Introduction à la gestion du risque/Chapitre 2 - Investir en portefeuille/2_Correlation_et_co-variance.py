...
# ddof=1 par défaut (correction de Bessel, estimateur non biaisé)
'''
...
sigma_Portfolio = sqrt(wT * Sigma * w)

    w     : vecteur colonne des poids (taille n)
    wT    : vecteur ligne transposé (1 x n)
    Sigma : matrice de covariance annualisée (n x n)
